...
print("Original price" + "\t"+str(item_original_price)+"("+item_original_currency+")")
purchase= usd_exchange_rates.get("CAD")*item_original_price
print("Purchase Price""\t"+str(purchase)+"("+item_purchase_currency+")")
