...
print("Original price:  $%0.2f (USD)"%item_original_price)
exchange_rate = usd_exchange_rates['CAD']
newPrice = item_original_price * exchange_rate
print("Purchased price: $%0.2f (CAD)"%newPrice)